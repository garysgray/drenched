...
const INTENSITY_MODES = { SLOW: 'slow', MED: 'med', FAST: 'fast' };

// Freeze all sub-sections once at startup
const _configData = 
{
  // ── Intensity presets ───────────────────────────────────────
...
// Freeze the CONFIG object to prevent new properties from being added
